#pragma checksum "C:\Users\jv.limbaroc\Desktop\SonicWMS\sonicwarehousemanagement\Client\Pages\EditSalesOrder.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2d29fc20892326fbe3636ee38f7f35a850530b92"
// <auto-generated/>
...
#line 152 "C:\Users\jv.limbaroc\Desktop\SonicWMS\sonicwarehousemanagement\Client\Pages\EditSalesOrder.razor"
    ...
    public async Task updatesalesorder()
    {
        ...
        var addHeaderItems = new InventoryHeader { Ref_ID = sodlist.Material_N, Item_Code = sodlist.Material_N, Ref_Type = "Sales Order"};
        await Http.PostJsonAsync("api/InventoryHeadersIndex/" + sodlist.Material_N, addHeaderItems);

        if(sodlist.Cases == "" || sodlist.Cases == "0")
        {
            var addDetailItems = new InventoryDetails { Header_Ref = sodlist.Material_N, Quantity = Int32.Parse(sodlist.Pieces), Uom = "PC", Transaction_Type = "Sales Order" };
            await Http.PostJsonAsync("api/InventoryDetailsIndex", addDetailItems);
            var addItems = new Inventory { Item_Code = sodlist.Item_Number, Quantity = Int32.Parse(sodlist.Pieces), Uom = "PC", Transaction_Type = "Sales Order" };
            await Http.PostJsonAsync("api/Inventories", addItems);
        }
        else
        {
            var addDetailItems = new InventoryDetails { Header_Ref = sodlist.Material_N, Quantity = Int32.Parse(sodlist.Cases), Uom = "CS", Transaction_Type = "Sales Order" };
            await Http.PostJsonAsync("api/InventoryDetailsIndex", addDetailItems);
            var addItems = new Inventory { Item_Code = sodlist.Item_Number, Quantity = Int32.Parse(sodlist.Cases), Uom = "CS", Transaction_Type = "Sales Order" };
            await Http.PostJsonAsync("api/Inventories", addItems);
        }
